(* Delphi 10 Unit
   verschiedene Unterroutinen für Windows Desktop und Shell
   ...
   Vers. 1 - Sep. 2002
   Vers. 2 - April 2016: SHFileOperation replaced by IFileOperation
   *)
...
function TaskBarAddIcon (WinHandle  : HWnd;
                         ...
                         IconHandle : HIcon;
                         const Title,Text,Tip : string) : boolean;
...
function TaskBarChangeBalloonTip (WinHandle  : HWnd;
                                  UserId     : integer;
                                  const Title,Text : string) : boolean;
// Icon in Taskbar ändern
function TaskBarChangeIcon (WinHandle  : HWnd;
                            UserId     : integer;
                            const Tip  : string;
                            IconHandle : HIcon) : boolean; overload;
...
function TaskBarChangeIcon (WinHandle  : HWnd;
                            ...
                            IconHandle : HIcon) : boolean;
begin
  Result:=TaskBarChangeIcon (WinHandle,UserId,'',IconHandle);
  end;
