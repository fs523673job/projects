...
typedef enum {
   LitePDFSignatureHash_SHA1   = 1, /**< Use SHA1 hash algorithm */
   LitePDFSignatureHash_SHA256 = 2, /**< Use SHA256 hash algorithm */
   LitePDFSignatureHash_SHA384 = 3, /**< Use SHA384 hash algorithm */
   LitePDFSignatureHash_SHA512 = 4  /**< Use SHA512 hash algorithm */
...
class TLitePDF
{
 ...
 public:
   ...
   */
   ...
   static double MMToUnitEx(TLitePDFUnit useUnit,
                            double mmValue);
   /**<
   ...
   */
   ...
   static double UnitToMMEx(TLitePDFUnit useUnit,
                            double unitValue);
   /**<
   ...
   */
   ...
   static double InchToUnitEx(TLitePDFUnit useUnit,
                              double inchValue);
   /**<
   ...
   */
   ...
   static double UnitToInchEx(TLitePDFUnit useUnit,
                              double unitValue);
   /**<
