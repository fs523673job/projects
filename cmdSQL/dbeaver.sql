...
SELECT * FROM FEATURE_CRIADAS WHERE NAME_PT LIKE '%853436%'
...
SELECT DISTINCT PT_NAME, DESC_PT FROM FEATURE_CRIADAS WHERE DATETIME_FIELD BETWEEN '2025-08-10' AND '2025-08-16'
