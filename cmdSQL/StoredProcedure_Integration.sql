...
begin
	begin transaction deleteData
		...
		insert into ServidoresIntegracoesBDs(BBO_CdiServidorIntegracaoBD, BBO_CdiServidorIntegracao, BBO_D1sServidorIntegracaoBD, BBO_CdiModeloIntegracao, BBO_CdiTipoIntegracao, BBO_CdiBaseDado, BBO_CdiTipoConexaoBaseDado, BBO_DssNomeServidor)                                values (16, 1, '(TESTES) MOCK POSTMAN GET COMPLEXY ARRAY',  10017, 1, 10, 1, 'https://20e776d9-fadf-47c1-91c9-02f58291b9c1.mock.pstmn.io/api/');
