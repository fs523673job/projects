...
function ScanBackwards(S: TStream): AnsiChar;
begin
...
procedure ReverseReadFromStreamUntil(S: TStream; const ASearch: AnsiString;
...
function XmlScanNodeFromEnd(S: TStream; ALevel: integer): Int64;
...
begin
  ...
  try
    ...
    M.SetSize(ASize + Length(Utf8Str));
    M.Write(Utf8Str[1], Length(Utf8Str));
    M.CopyFrom(S, ASize);
