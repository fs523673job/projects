...
//---------------------------------------------------------------------------
   ...
   TLitePDFSignatureHash = (
                  LitePDFSignatureHash_SHA1   = $0001, {**< Use SHA1 hash algorithm *}
                  LitePDFSignatureHash_SHA256 = $0002, {**< Use SHA256 hash algorithm *}
                  LitePDFSignatureHash_SHA384 = $0003, {**< Use SHA384 hash algorithm *}
                  LitePDFSignatureHash_SHA512 = $0004  {**< Use SHA512 hash algorithm *}
   );
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
   ...
   public
      ...
      *}
      ...
      procedure SetSignatureHash(signatureHash : TLitePDFSignatureHash);
      {**<
         Sets the signature hash algorithm to be used. The default value is @ref LitePDFSignatureHash_SHA512.
         It is used only when the @ref SaveToFileWithSign or
         @ref SaveToDataWithSign are used. The supported
         values are @ref LitePDFSignatureHash_SHA1, @ref LitePDFSignatureHash_SHA256,
         @ref LitePDFSignatureHash_SHA384 and @ref LitePDFSignatureHash_SHA512.

         This value is remembered in general, not for any signature in particular.

         @param signatureHash The hash algorithm to use.

         @see SetSignatureSize, SaveToFileWithSignManual, SaveToFileWithSignManualW, SaveToDataWithSignManual
      }
...
procedure TLitePDF.SetSignatureHash(signatureHash : TLitePDFSignatureHash);
const _func = 'TLitePDF.SetSignatureHash';
type lpfunc = function(pctx : Pointer; signatureHash : LongWord) : BOOL; stdcall;
var func : lpfunc;
begin
   ensureLibraryLoaded(_func);
   ...
   freeLastError;
   func := lpfunc(GetProc('litePDF_SetSignatureHash'));

   ThrowLastErrorIfFail(func(context, LongWord(signatureHash)), self, _func);
end;
